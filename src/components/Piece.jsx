...
// Premium Lichess-style Chess Pieces (Cburnett set)
const Piece = ({ type, color }) => {
  ...
  const pieces = {
    ...
    k: isWhite ? (
      ...
      <svg viewBox="0 0 45 45" className="piece">
        <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-2.5-7.5-12-10.5-16-4-3 6 6 10.5 6 10.5v7" fill="#000" stroke="#000"/>
          <path d="M20 8h5" strokeLinejoin="miter"/>
          <path d="M32 29.5s8.5-4 6.03-9.65C34.15 14 25 18 22.5 24.5v2.1-2.1C20 18 10.85 14 6.97 19.85 4.5 25.5 13 29.5 13 29.5" fill="#000" stroke="#fff"/>
    ...
    q: isWhite ? (
      ...
      <svg viewBox="0 0 45 45" className="piece">
        <g fill="#000" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-.3-14.1-5.2 13.6-3-14.5-3 14.5L14.3 10.9 14 25 6.5 13.5 9 26z" strokeLinecap="butt"/>
          ...
          <path d="M11.5 30c3.5-1 18.5-1 22 0m-21 3c5.5-1 17.5-1 21 0" fill="none" stroke="#fff"/>
          <circle cx="6" cy="12" r="2"/>
          <circle cx="14" cy="9" r="2"/>
          <circle cx="22.5" cy="8" r="2"/>
          <circle cx="31" cy="9" r="2"/>
    ...
    b: isWhite ? (
      ...
      <svg viewBox="0 0 45 45" className="piece">
        <g fill="#000" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.35.49-2.32.47-3-.5 1.35-1.46 3-2 3-2z" strokeLinecap="butt"/>
    ...
    n: isWhite ? (
      <svg viewBox="0 0 45 45" className="piece">
        <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zm5.433-9.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill="#000" strokeWidth="1.5"/>
        </g>
      </svg>
    ) : (
      <svg viewBox="0 0 45 45" className="piece">
        <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-1-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-2 2.5-3c1 0 1 3 1 3" fill="#000"/>
